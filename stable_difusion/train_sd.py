...
def parse_args():
    ...
    parser.add_argument(
        "--train_list",
        type=str,
        default="filenames/train_filenames_256.txt",
        required=False,
        help="train images list.",
    )
    parser.add_argument(
        "--test_list",
        type=str,
        default="filenames/test_filenames_256.txt",
        required=False,
        help="test images list.",
    )
    parser.add_argument(
        "--max_train_samples",
        type=int,
    ...
    parser.add_argument(
        ...
        type=str,
        default="Custom_StableDiffusion",
        help=(
    ...
    if args.dataset_path is None:
        raise ValueError("DataPath is requird.")
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_loader):
            with accelerator.accumulate(unet):
                ...
                h_disp = vae.encoder(depth_map.to(weight_dtype))
                ...
                noise = pyramid_noise_like(disp_latents) # create noise
